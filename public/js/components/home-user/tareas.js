...
document.addEventListener("DOMContentLoaded", function () {
    ...
    (function () {
        ...
        const btnPrint = document.getElementById("btn-print-iframe");
        const btnDownload = document.getElementById("btn-download-pdf");
        const modalEl = document.getElementById("pdfPreviewModal");
        // Obtener URL del PDF desde atributo data o usar valor por defecto
        const pdfUrl = btnPreview.getAttribute('data-pdf-url') || btnPreview.dataset.pdfUrl || '/tareas/imprimir-todas';
        ...
        // Validar elementos
        if (!btnPreview || !iframe || !modalEl) {
            console.warn('Elementos del modal PDF no encontrados');
            return;
        }
        ...
        // Ocultar loader cuando el iframe haya cargado
        if (iframe) {
        ...
        // Funcionalidad de imprimir y descargar
        if (btnPrint) {
            btnPrint.addEventListener("click", function (e) {
                ...
                try {
                    ...
                    if (iframeWindow) {
                        ...
                        alert("No se puede acceder al contenido del PDF para imprimirlo. Use el botón Descargar.");
                    }
                } catch (err) {
                    console.error("Error al intentar imprimir:", err);
                    alert("No fue posible iniciar la impresión. Intente descargar el PDF.");
                }
            });
        }
