...
<div class="login-container">
    ...
    <div class="left-section">
        ...
        <div class="content-wrapper">
            ...
            <h1 class="tagline">Ecosistema Inteligente de Apiarios</h1>
            <p class="subtitle">Revoluciona la administración de tus colmenas con tecnología de vanguardia y monitoreo avanzado</p>
            ...
            <div class="features">
                <div class="feature-item">
                    <div class="feature-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 1H9V3H13.5L19 8.5V9H21ZM21 11H15C14.4 11 14 10.6 14 10S14.4 9 15 9H21C21.6 9 22 9.4 22 10S21.6 11 21 11ZM3 13V11H9V13H3ZM21 15H9V13H21V15ZM21 19V17H3V19H21Z"/>
                        </svg>
                    </div>
                ...
                <div class="feature-item">
                    <div class="feature-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M17,4H20A2,2 0 0,1 22,6V20A2,2 0 0,1 20,22H4A2,2 0 0,1 2,20V6A2,2 0 0,1 4,4H7V2H9V4H15V2H17V4M4,8V20H20V8H4M6,10H8V12H6V10M10,10H12V12H10V10M14,10H16V12H14V10M18,10H20V12H18V10Z"/>
                        </svg>
                    </div>
