...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('apiarios.update', $apiario->id) }}" method="POST" enctype="multipart/form-data"
            class="p-4 shadow-sm" style="background-color: #FFF8E1; border-radius: 10px;">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <div id="preview-container" style="margin-top: 15px;">
                    ...
                    <p id="error-message" style="color: red; display: none;">El archivo seleccionado no es una imagen
                        válida.</p>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="temporada_produccion" name="temporada_produccion"
                        value="{{ $apiario->temporada_produccion }}" required style="border: 1px solid #FFB800;">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="registro_sag" name="registro_sag"
                        value="{{ $apiario->registro_sag }}" required style="border: 1px solid #FFB800;">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="num_colmenas" name="num_colmenas"
                        value="{{ $apiario->num_colmenas }}" required style="border: 1px solid #FFB800;">
                </div>
                <div class="form-group col-md-6">
                    <label for="tipo_apiario" style="color: #FF8C00;">Tipo de Apiario</label>
                    <input type="text" class="form-control" id="tipo_apiario" name="tipo_apiario"
                        value="{{ $apiario->tipo_apiario }}" required style="border: 1px solid #FFB800;">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="tipo_manejo" name="tipo_manejo"
                        value="{{ $apiario->tipo_manejo }}" required style="border: 1px solid #FFB800;">
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="objetivo_produccion" name="objetivo_produccion"
                        value="{{ $apiario->objetivo_produccion }}" required style="border: 1px solid #FFB800;">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <div id="map"
                        style="height: 300px; margin-bottom: 15px; border: 2px solid #FFB800; border-radius: 8px;"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="latitud" name="latitud" value="{{ $apiario->latitud }}"
                        readonly required style="border: 1px solid #FFB800;">
                </div>
                <div class="form-group col-md-6">
                    <label for="longitud" style="color: #FF8C00;">Longitud</label>
                    <input type="text" class="form-control" id="longitud" name="longitud" value="{{ $apiario->longitud }}"
                        readonly required style="border: 1px solid #FFB800;">
                </div>
            </div>
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-warning px-4"
                    style="background-color: #FFB800; color: white; font-weight: bold;">Guardar Cambios</button>
            </div>
        </form>
    </div>
