    ...
    <div class="container">
        ...
        <form action="{{ route('apiarios.store') }}" method="POST" enctype="multipart/form-data" class="fade-in-up">
            ...
            <div class="form-group">
                ...
                <div class="custom-tooltip" data-tooltip-for="nombre">
                    Asigna un nombre único y descriptivo a tu apiario para identificarlo fácilmente.
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="preview-container">
                    <img id="preview-image" alt="Vista previa de la imagen" style="display: none; max-height: 200px; margin: 15px auto;">
