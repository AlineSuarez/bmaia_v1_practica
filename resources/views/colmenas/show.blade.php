                                                ...
                                                <li class="pcc-list-item">
                                                    ...
                                                    <span class="pcc-list-value">
                                                        ...
                                                        if (is_string($reemplazos)) {
                                                            ...
                                                            if (is_array($json)) $reemplazos = $json;
                                                        }
                                                    @endphp
                                                    <span class="pcc-list-value">
                                                        @if(is_array($reemplazos))
                                                            @foreach($reemplazos as $rep)
                                                                @if(is_array($rep) && isset($rep['fecha']))
                                                                    <div>
                                                                        <strong>Fecha:</strong> {{ \Carbon\Carbon::parse($rep['fecha'])->format('d/m/Y') }}
                                                                        @if(isset($rep['motivo']))
                        ...
                        <div class="modal-body">
                            <div class="form-group-modal">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('nombre', $colmena->nombre) }}"
                            ...
                            <div class="form-group-modal">
                                ...
                                <input type="number" 
                                       ...
                                       id="edit_numero" 
                                       class="form-control-modal"
                                       value="{{ old('numero', $colmena->numero) }}"
                                       min="1"
                                       required>
