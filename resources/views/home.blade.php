          ...
          <div class="metric-card actualizar-plan">
            <a href="{{ route('user.settings') }}#plans" class="metric-link">
              ...
              <div class="metric-content">
                ...
                <div class="metric-detail">
                  @if(!$plan_active)
                    <span class="metric-badge">Sin plan activo</span>
                  @elseif($planLabel === 'Drone')
                    <span class="metric-badge">Prueba gratuita activa</span>
                  @else
                    <span class="metric-badge">
                      Vence: {{ $plan_end_date ? \Carbon\Carbon::parse($plan_end_date)->format('d/m/Y') : '—' }}
                    </span>
                  @endif
                </div>
              </div>
