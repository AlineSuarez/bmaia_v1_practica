...
<head>
    ...
    <!-- jQuery + Moment + FullCalendar + Chart.js -->
    ...
    <!-- DataTables + FA 6.0 beta + Select2 -->
    ...
    <!-- Font Awesome 6.5.0 (AGREGADO) -->
    <link rel="stylesheet"
          href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"
          integrity="sha512-1ycn6IcaQQ40/MKBW2W4Rz5VQ5Fh9vDOMkMt2rt7NmexG99HCaTKty+O3O5+ywOB1p5MNDoZCE3BzKBd3P9aWg=="
...
<body>
    ...
    <!-- JS Bootstrap + Toastr + Shepherd + DataTables + SweetAlert + Proj4 + scripts propios -->
