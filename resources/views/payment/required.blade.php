    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted">Tu prueba gratuita ha finalizado. Selecciona un plan para continuar</p>
            </div>
            ...
            <!-- Mensaje informativo sobre prueba gratuita finalizada -->
            <div class="alert alert-info border-0 shadow-sm mb-4">
                <div class="d-flex align-items-center">
                    <i class="fas fa-info-circle fs-4 me-3"></i>
                    <div>
                        <h5 class="mb-1">Tu prueba gratuita de 16 días ha finalizado</h5>
                        <p class="mb-0">Para continuar disfrutando de todas las funcionalidades, selecciona uno de nuestros planes de pago.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="process-info-section mt-4">
                    <div class="info-card">
                        ...
                        <div class="info-content">
                            ...
                            <p>Si eres una persona natural que realiza actividades comerciales de apicultura, puedes
                                usar cualquiera de las dos opciones. La facturación es especialmente útil si necesitas
                                el documento para fines contables o tributarios.</p>
                        </div>
                    </div>
                </div>
            </div>
