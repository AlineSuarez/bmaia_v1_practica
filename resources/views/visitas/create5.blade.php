        ...
        <form method="POST" action="{{ route('visitas.store5', $apiario->id) }}" class="harvest-form">
                ...
                <div class="field-group quality-grid">
                    <div class="form-field">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('madurez_miel', $indiceCosecha->madurez_miel ?? '') }}" 
                               required>
                    ...
                    <div class="form-field">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('num_alzadas', $indiceCosecha->num_alzadas ?? '') }}" 
                               required>
                    ...
                    <div class="form-field">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('marcos_miel', $indiceCosecha->marcos_miel ?? '') }}" 
                               required>
            ...
            <footer class="form-actions">
                <div class="actions-container">
                    <a href="{{ route('visitas.historial', $apiario->id) }}" class="btn btn-secondary">
                        <span class="btn-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
