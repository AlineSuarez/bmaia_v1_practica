...
@section('content')
    <div class="apiary-dashboard">
        ...
        <div class="tabs-container">
            <div class="tabs-nav">
                @if(isset($apiariosFijos) && $apiariosFijos->count())
                    <button class="tab-btn active" data-tab="fijos">
                        <i class="fas fa-home"></i>
                        <span>Apiarios Fijos</span>
                        <span class="tab-count">{{ $apiariosFijos->count() }}</span>
                    </button>
                @endif
                ...
                @if(isset($apiariosArchivados) && $apiariosArchivados->count())
                    <button class="tab-btn" data-tab="archivados">
                        <i class="fas fa-archive"></i>
                        <span>Archivados</span>
                        <span class="tab-count">{{ $apiariosArchivados->count() }}</span>
                    </button>
                @endif
            </div>
        </div>
        ...
        <div class="apiary-section">
            {{-- Sección Apiarios Fijos --}}
            @if(isset($apiariosFijos) && $apiariosFijos->count())
                <div class="tab-content active" id="tab-fijos">
                    <div class="apiaries-container card-view" id="apiariesFijosContainer">
            ...
            {{-- Sección Apiarios Archivados --}}
            @if(isset($apiariosArchivados) && $apiariosArchivados->count())
                <div class="tab-content" id="tab-archivados">
                    <div class="apiaries-container card-view" id="apiariesArchivadosContainer">
            ...
            @if(
                    (!isset($apiariosFijos) || !$apiariosFijos->count()) &&
                    (!isset($apiariosBase) || !$apiariosBase->count()) &&
                    (!isset($apiariosTemporales) || !$apiariosTemporales->count()) &&
                    (!isset($apiariosArchivados) || !$apiariosArchivados->count())
                )
