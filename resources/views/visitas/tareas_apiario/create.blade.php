            ...
            <section class="form-section task-timeline">
                ...
                <div class="field-group timeline-grid">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" name="proximo_seguimiento" class="field-input"
                            placeholder="Indique el próximo seguimiento..."
                            value="{{ old('proximo_seguimiento', $tarea->proximo_seguimiento ?? '') }}">
                        <span class="field-helper">Próxima revisión o seguimiento planificado</span>
                    </div>
                </div>
            </section>
