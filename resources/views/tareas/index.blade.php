    ...
    <div class="apiario-wrapper">
        ...
        <section class="apiario-controls">
            <div class="view-controls">
                ...
                <button class="btn-panal view-toggler" data-view="kanban" title="Ver en formato tablero">Tablero</button>
                <button class="btn-panal view-toggler" data-view="timeline" title="Ver en línea temporal">Línea de Tiempo</button>
                <button class="btn-panal view-toggler" data-view="calendar" title="Ver en calendario">Calendario</button>
            </div>
            ...
            <div class="panel-grid-container">
                ...
                <div class="panel-column tareas-predefinidas">
                    <form method="POST" action="{{ route('tareas.default') }}">
                        ...
                        <small class="consejo-sutil">Consejo: Utiliza tareas predefinidas para ahorrar tiempo en la planificación</small>
                                        ...
                                        @foreach ($tareaGeneral->predefinidas as $subtarea)
                                            <tr class="fila-tarea">
                                                <td class="celda-check">
                                                    <input type="checkbox" name="subtareas[]" value="{{ $subtarea->id }}" class="check-miel subtask-checkbox">
                                                </td>
                                                <td></td>
                        ...
                        <div class="nota-sutil">Nota: Las tareas seleccionadas se añadirán con sus fechas y prioridades originales</div>
                ...
                <div class="panel-column tareas-personalizadas">
                    <form action="{{ route('tareas.store') }}" method="POST">
                        ...
                        <p class="section-description">Diseña tus propias tareas adaptadas a las necesidades de tu proyecto.</p>
                        <small class="consejo-sutil">Consejo: Divide los grandes objetivos en tareas más pequeñas y manejables</small>
                        ...
                        <div id="subtareas-container" class="contenedor-subtareas">
                            ...
                            <div class="mini-guia">
                                <span class="guia-item"><strong>Prioridad alta:</strong> Tareas críticas para el avance</span>
                            ...
                            <div class="subtarea" id="subtarea-template" style="display: none;">
                                <div class="fila-form">
                                    ...
                                    <div class="columna-form">
                                        ...
                                        <input type="text" data-field="nombre" class="input-miel" placeholder="Ej: Preparar documentación">
                                    </div>
                                    <div class="columna-form">
