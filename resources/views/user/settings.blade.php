            ...
            <section class="tab-pane fade" id="permissions" role="tabpanel" aria-labelledby="permissions-tab">
                <div class="card settings-card mb-4">
                    <div class="card-header">
                        ...
                        <p class="text-muted">Configura los permisos que deseas otorgar a la aplicación para mejorar tu
                            experiencia y funcionalidad.</p>
                    </div>
                    <div class="card-body">
                        <form id="permissions-form" class="permissions-form">
                            <div class="permission-item mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="allow_notifications"
                                        name="allow_notifications" {{ ($user->allow_notifications ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label ml-4" for="allow_notifications">
                                        <strong>Permitir Notificaciones</strong>
                                    </label>
                                </div>
                                <div class="permission-details">
                                    <p class="text-muted">Personaliza qué tipo de notificaciones deseas recibir, ya sean
                                        alertas, recordatorios de tareas (alimentación, inspección), avisos de BeeMaiA
                                        (nuevas
                                        funcionalidades, informes generados), entre otras notificaciones disponibles.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="permission-item mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="allow_camera" name="allow_camera" {{ ($user->allow_camera ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="allow_camera">
                                        <strong>Permitir acceso a imágenes y cámara</strong>
                                    </label>
                                </div>
                                <div class="permission-details">
                                    <p class="text-muted">Otorga permiso a la aplicación para acceder a la galería de tu
                                        dispositivo y utilizar la cámara. Esto permitirá adjuntar fotos y videos de las
                                        colmenas, plagas, enfermedades o la flora circundante a tus colmenas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="permission-item mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="allow_microphone"
                                        name="allow_microphone" {{ ($user->allow_microphone ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="allow_microphone">
                                        <strong>Activar Micrófono</strong>
                                    </label>
                                </div>
                                <div class="permission-details">
                                    <p class="text-muted">Permite que la aplicación utilice el micrófono de tu dispositivo
                                        para interactuar con BeeMaiA a través de comandos de voz.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="permission-item mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="allow_location"
                                        name="allow_location" {{ ($user->allow_location ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="allow_location">
                                        <strong>Activar Ubicación o GPS</strong>
                                    </label>
                                </div>
                                <div class="permission-details">
                                    <p class="text-muted">Permite que la aplicación acceda a la ubicación de tu
                                        dispositivo. Esto puede ser útil para geolocalizar tus apiarios, registrar la
                                        ubicación
                                        de las colmenas individuales o analizar datos climáticos locales relevantes para tus
                                        abejas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="permission-item mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="allow_bluetooth"
                                        name="allow_bluetooth" {{ ($user->allow_bluetooth ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="allow_bluetooth">
                                        <strong>Conectar tus Dispositivos Bluetooth</strong>
                                    </label>
                                </div>
                                <div class="permission-details">
                                    <p class="text-muted">Mantente conectado de forma segura y cómoda. Este sistema permite
                                        la conexión Bluetooth con diversos dispositivos, como altavoces portátiles, manos
                                        libres
                                        en vehículos, audífonos inalámbricos, gafas inteligentes y otros dispositivos
                                        inalámbricos según tus necesidades.
                                    </p>
                                </div>
                            </div>

                            <div class="form-actions mt-4">
                                <button type="button" class="btn btn-primary" id="savePermissionsBtn">Guardar
                                    Permisos</button>
                                <button type="reset" class="btn btn-outline-secondary ms-2">Restablecer</button>
                            </div>
                        </form>
